...
class EtudiantCubit extends Cubit<EtudiantState> {
  EtudiantCubit() : super(EtudiantInitial());
  ...
  Future<void> getCurrentEtudiantInfo() async {
    emit(LodinGetCurrentEtudiantDetailState());
    ...
    await DioHelper.getData(
      ...
      emit(GetCurrentEtudiantDetailStateGood());
    }).catchError((e) {
      print(e.toString());
      emit(GetCurrentEtudiantDetailStateBad(e.toString()));
    });
  }
